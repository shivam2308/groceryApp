...
public class OrderSummaryMiniListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // private CheckOutFragmnet checkOutFragmnet;
     ...
     * setup Constructure
     */
    public OrderSummaryMiniListAdapter(List<OrderListModelNew> orderListModelNewList, Context mContext) {
