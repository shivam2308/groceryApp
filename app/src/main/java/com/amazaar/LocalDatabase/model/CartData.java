...
public class CartData implements IData {
    ...
    public String toJson() {
        Gson gson = new Gson();
        return gson.toJson(this, CartData.class);
    }

    public static CartData fromJson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, CartData.class);
    }
