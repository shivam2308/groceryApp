...
public class CustomerLoginCF extends AControlFlow<CustomerLoginCF.State, Void, Exception> {
    ...
    public CustomerLoginCF(LoginClientService LoginClientService, String Mobile, LoginEntityDaoHelper loginEntityDaoHelper, DeviceAutoLogin deviceAutoLogin, ProfileSubmitWidget profileSubmitWidget) {
